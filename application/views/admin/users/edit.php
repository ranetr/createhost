...
<?php echo $header ?>
				...
				<div class="btn-group">
					<a href="/admin/licenses/index?userid=<?php echo $user['user_id'] ?>" class="btn btn-secondary"><i class="icon ion-md-key"></i> Лицензии пользователя</a>
				...
				<form action="#" id="editForm" method="POST">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="email" readonly class="form-control" id="email" name="email" placeholder="Введите E-Mail" value="<?php echo $user['user_email'] ?>">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						<label class="col-sm-3 col-form-label text-sm-right">Зарегистрирован:</label>
						<div class="col-sm-5">
							<input type="text" readonly class="form-control-plaintext" id="staticDataReg" value="<?php echo date("d.m.Y в H:i", strtotime($user['user_date_reg'])) ?>">
						</div>
					</div>
					<div class="pb-2 mt-4 mb-2">
						<h4>Пароль</h4>
