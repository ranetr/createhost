<?php echo $header ?>
				<div class="pb-2 mt-4 mb-2">
					<h2>Продление лицензии #<?php echo $license['license_id'] ?></h2>
				</div>
				...
				<script>
					$('#payForm').ajaxForm({ 
						url: '/licenses/pay/ajax/<?php echo $license['license_id'] ?>',
						dataType: 'text',
						success: function(data) {
							...
							switch(data.status) {
								...
								case 'success':
									...
									setTimeout("redirect('/licenses/control/index/<?php echo $license['license_id'] ?>')", 1500);
									break;
							}
						},
